...
public class JoystickSetterExample : MonoBehaviour
{
    ...
    public void AxisChanged(int index)
    {
        ...
        {
            case 0:
                variableJoystick.AxisOptions = NSY.AxisOptions.Both;
                background.sprite = axisSprites[index];
                break;
            case 1:
                variableJoystick.AxisOptions = NSY.AxisOptions.Horizontal;
                background.sprite = axisSprites[index];
                break;
            case 2:
                variableJoystick.AxisOptions =NSY.AxisOptions.Vertical;
                background.sprite = axisSprites[index];
                break;
            default:
                break;
